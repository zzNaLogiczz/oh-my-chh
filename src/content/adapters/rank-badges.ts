...
function normalizeRankLabel(label: string): string {
...
export function enhanceRankBadge(rankElement: Element, identity: RankBadgeIdentity, rawLabel: string): void {
  ...
  rankElement.replaceChildren(badge);
}
